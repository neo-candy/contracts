...
public class LollipopNFTMintTest extends AbstractLollipopNFTTest {
    ...
    void currentPriceTest() throws IOException {
        ...
        assertNull(result.getInvocationResult().getException());
        assertEquals(INITIAL_MINT_PRICE, result.getInvocationResult().getStack().get(0).getInteger().longValue());
    }
    ...
    void mintTo50PriceUnchangedTest() throws IOException {
        ...
        assertDoesNotThrow(
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(INITIAL_MINT_PRICE), lollipopNFT,
                        neow3j, false));
    }
    ...
    void mintPriceChangesAt50() throws IOException {
        ...
        assertThrows(
                ...
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(INITIAL_MINT_PRICE), lollipopNFT,
                        neow3j, false));
        assertDoesNotThrow(
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(SECOND_MINT_PRICE), lollipopNFT,
                        neow3j, false));
    }
    ...
    void mintPriceChangesAt100() throws IOException {
        ...
        assertThrows(
                ...
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(SECOND_MINT_PRICE), lollipopNFT,
                        neow3j, false));
        assertDoesNotThrow(
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(THIRD_MINT_PRICE), lollipopNFT,
                        neow3j, false));
    }
    ...
    void mintPriceChangesAt150() throws IOException {
        ...
        assertThrows(
                ...
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(THIRD_MINT_PRICE), lollipopNFT,
                        neow3j, false));
        assertDoesNotThrow(
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(FOURTH_MINT_PRICE), lollipopNFT,
                        neow3j, false));
    }
    ...
    void mintPriceChangesAt200() throws IOException {
        ...
        assertThrows(
                ...
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(FOURTH_MINT_PRICE), lollipopNFT,
                        neow3j, false));
        assertDoesNotThrow(
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(FIFTH_MINT_PRICE), lollipopNFT,
                        neow3j, false));
    }
    ...
    void mintPriceChangesAt218() throws IOException {
        ...
        assertThrows(
                ...
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(FIFTH_MINT_PRICE), lollipopNFT,
                        neow3j, false));
        assertDoesNotThrow(
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(SIXTH_MINT_PRICE), lollipopNFT,
                        neow3j, false));
    }
    ...
    void mintPriceChangesAt220() throws IOException {
        ...
        assertThrows(
                ...
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(SIXTH_MINT_PRICE), lollipopNFT,
                        neow3j, false));
        assertDoesNotThrow(
                () -> TestHelper.mintNFT(candyToken, alice, BigInteger.valueOf(SEVENTH_MINT_PRICE), lollipopNFT,
                        neow3j, false));
    }
